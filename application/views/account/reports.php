...
<div id="reportsSettings">
    ...
    <div id="account-reports-list-section" class="padding-5">
        <p>
            <?php echo __('We send a monthly Grapevine report to highlight key item like your OCSI Score, Current Star Rating, Review samples and more. Please add your desired email recipients below.'); ?>
        </p>
