...
class tmhUtilities {
   ...
   */
  static function entify($tweet, &$replacements=array()) {
    $keys = array();
    // $replacements = array();
    $is_retweet = false;
   ...
   */
  static function auto_fix_time_request($tmhOAuth, $method, $url, $params=array(), $useauth=true, $multipart=false) {
   ...
   */
  static function read_input($prompt) {
    echo $prompt;
   ...
   */
  static function read_password($prompt, $stars=false) {
    echo $prompt;
